...
const char* CSR_batchFile = "../../../BatchFiles_Dir/sample.bat";                                
const char* PSE_batchFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
const char* INO_batchFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
const char* IGC_BatchFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
const char* GVF_bathcFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
const char* DLE_batchFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
const char* CFU_batchFile = "../../../BatchFiles_Dir/<add the name of the batch file in here>";  
...
std::string read_data_from_bat_file; 
    ...
    while (!done)
    {
        ...
        if(!is_in_welcomePage)
        {
            ...
            ImGui::Begin("CMD viewport");
            {
                ...
                ImGui::InputTextMultiline("##cmd", &bat_output, ImVec2(ImGui::GetWindowWidth(), ImGui::GetWindowHeight() - 48), ImGuiInputTextFlags_ReadOnly);
                if(!read_data_from_bat_file.empty())
                {
...
void ControlPanel()
{
    ...
    {
        read_data_from_bat_file = CSR_batchFile;
    }

    ButtonSpacerPadding(pan_col1,7);
    if(ImGui::Button(Button2, ButtonSize))
    {
        read_data_from_bat_file = PSE_batchFile;
    }

    ButtonSpacerPadding(pan_col1,7);
    if(ImGui::Button(Button3, ButtonSize))
    {
        read_data_from_bat_file = INO_batchFile;
    }

    ButtonSpacerPadding(pan_col1,7);
    if(ImGui::Button(Button4, ButtonSize))
    {
        read_data_from_bat_file = IGC_BatchFile;
    }

    ButtonSpacerPadding(pan_col1,7);
    if(ImGui::Button(Button5, ButtonSize))
    {
        read_data_from_bat_file = GVF_bathcFile;
    }
    ...
    {
        read_data_from_bat_file = DLE_batchFile;
    }
    ...
    ImGui::NextColumn();
        ...
        {
            read_data_from_bat_file = CFU_batchFile;
        }
